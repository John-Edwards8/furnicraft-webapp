...
public class ClientsView extends Div implements BeforeEnterObserver {
    ...
    private final Grid<ClientResponseDto> grid = new Grid<>(ClientResponseDto.class, false);
    ...
    public ClientsView(ClientServiceClient clientService) {
        ...
        // Configure Form
        binder = new BeanValidationBinder<>(ClientResponseDto.class);
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (personId.isPresent()) {
            Optional<ClientResponseDto> personFromBackend = clientService.getClientById(personId.get());
    ...
    private void populateForm(ClientResponseDto value) {
        this.person = value;
